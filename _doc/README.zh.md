...
我的博客仓库——`v4liulv.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:v4liulv/huxblog-boilerplate.git
```

**[在这里预览模板 &rarr;](https://liulv.work/huxblog-boilerplate/)**
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/v4liulv/v4liulv.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`v4liulv.github.io`这个repository点个赞——右上角**star**一下。
...
# SNS settings      
github_username: v4liulv     # 你的github账号
weibo_username: v4liulv      # 你的微博账号，底部链接会自动更新的。
...
看右边:
![](https://liulv.work/img/blog-sidebar.jpg)
...
![](https://liulv.work/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "https://liulv.work/js-module-7day/"
---
```
...
ga_domain: liulv.work			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/v4liulv/v4liulv.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
