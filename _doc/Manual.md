...
It's possible that you want the two things different. For me, my site-title is **“Hux Blog”** but I want the title shows in search engine is **“刘律的博客 | Hux Blog”** which is multi-language.
