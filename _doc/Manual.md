...
```yml
# Site settings
title: LiuL Blog             # title of your website
SEOTitle: LiuL Blog          # check out docs for more detail
...
sidebar-avatar: /img/avatar-LiuL.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“LiuL Blog”** but I want the title shows in search engine is **“刘律的博客 | LiuL Blog”** which is multi-language.
...
<img src="https://liulv.work/img/blog-md-navbar.gif" width="320" />
