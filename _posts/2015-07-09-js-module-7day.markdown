...
iframe:     "//liulv.work/js-module-7day/"
date:       2015-07-09
author:     "LiuL"
tags:
    - Slides
...
### [Watch Fullscreen →](https://liulv.work/js-module-7day/)

<div class="visible-md visible-lg">
<img src="//liulv.work/js-module-7day/attach/qrcode.png" width="350"/>
<small class="img-hint">你也可以通过扫描二维码在手机上观看</small>
</div>


这个 Web Slides 开源在[我的 Github 上](https://github.com/v4liulv/js-module-7day)，欢迎你帮助我完善这个展示文稿，你可以给我提 issue，可以 fork & pull request。如果它能帮助到你了，希望你还能不吝啬 star 一下这个项目
